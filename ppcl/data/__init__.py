...
from ppcl.data import dataloader
# dataset
...
from ppcl.data.dataloader.face_dataset import FiveValidationDataset, AdaFaceDataset
...
# sampler
from ppcl.data.dataloader.DistributedRandomIdentitySampler import DistributedRandomIdentitySampler
...
from ppcl.data.dataloader.ra_sampler import RASampler
from ppcl.data import preprocess
from ppcl.data.preprocess import transform
...
def build_dataloader(config, mode, device, use_dali=False, seed=None):
    ...
    if use_dali and paddle.device.is_compiled_with_cuda():
        from ppcl.data.dataloader.dali import dali_dataloader
