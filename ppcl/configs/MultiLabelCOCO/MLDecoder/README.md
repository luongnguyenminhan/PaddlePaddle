...
python3 ./ppcl/utils/create_coco_multilabel_lists.py \
...
python3 -m paddle.distributed.launch \
    --gpus="0,1,2,3" \
    tools/train.py \
        -c ./ppcl/configs/MultiLabelCOCO/MLDecoder/ResNet101_ml_decoder_448.yaml
# 单卡
...
python3 python/predict_cls.py \
    ...
    -o PostProcess.MultiLabelThreshOutput.class_id_map_file=../ppcl/utils/COCO2017_label_list.txt 
# 使用下面的命令使用 CPU 进行预测
python3 python/predict_cls.py \
    -c configs/inference_cls_multilabel.yaml \
    -o Global.inference_model_dir=../inference/ \
